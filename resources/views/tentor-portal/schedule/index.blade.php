                        ...
                        <tr class="hover:bg-slate-700/10 transition-colors border-b border-slate-700/30">
                            ...
                            @for($hari = 1; $hari <= 7; $hari++)
                                    <td class="p-1 align-top border-r border-slate-700/30">
                                        ...
                                        @if($item)
                                            @if($item->id_siswa == 1)
                                                <div class="bg-emerald-500/20 border border-emerald-500/30 text-emerald-400 text-[9px] font-bold px-1.5 py-0.5 rounded text-center uppercase tracking-wider">
                                                    BISA
                                                </div>
                                            @else

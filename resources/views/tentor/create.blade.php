...
@section('content')
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-white tracking-tight">Tambah Tentor Baru</h1>
    </div>

    <div class="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl shadow-xl overflow-hidden">
        <form action="{{ route('tentors.store') }}" method="POST" class="p-6 md:p-8 space-y-6">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="wa" id="wa" value="{{ old('wa') }}" required
                        class="w-full bg-slate-900 border border-slate-700 rounded-lg px-4 py-2.5 text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all placeholder-slate-600">
                </div>
            ...
            <div class="space-y-2">
                ...
                <textarea name="alamat" id="alamat" rows="3"
                    class="w-full bg-slate-900 border border-slate-700 rounded-lg px-4 py-2.5 text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all placeholder-slate-600">{{ old('alamat') }}</textarea>
            </div>
            ...
            <div class="space-y-2">
                ...
                <textarea name="ket_pendidikan" id="ket_pendidikan" rows="3"
                    class="w-full bg-slate-900 border border-slate-700 rounded-lg px-4 py-2.5 text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all placeholder-slate-600">{{ old('ket_pendidikan') }}</textarea>
            </div>

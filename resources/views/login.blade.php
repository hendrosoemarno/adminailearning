...
<body>
    <div class="login-container">
                ...
                <div class="password-container">
                    ...
                    <button type="button" class="password-toggle" onclick="togglePassword('password', this)">
                        <svg class="eye-icon w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            id="eye-open" style="width: 20px; height: 20px;">
                        ...
                        <svg class="eye-icon w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                            id="eye-closed" style="display: none; width: 20px; height: 20px;">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div style="margin-top: 1.5rem; font-size: 0.9rem; color: var(--text-secondary);">
            Belum punya akun siswa? <a href="{{ route('register') }}"
                style="color: var(--accent); text-decoration: none; font-weight: 500;">Daftar di sini</a>
        </div>
    </div>
    <script>
